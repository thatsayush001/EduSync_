...
import { jatin, pallavi } from "../../assets/index"

import test1 from '../../assets/Pics/RaghuGallery/Zephyr/1.jpg'
import test2 from '../../assets/Pics/RaghuGallery/Zephyr/2.jpg'
import test3 from '../../assets/Pics/RaghuGallery/Zephyr/3.jpg'
import test4 from '../../assets/Pics/RaghuGallery/Zephyr/4.jpg'
import test5 from '../../assets/Pics/RaghuGallery/Zephyr/5.jpg'
import test6 from '../../assets/Pics/RaghuGallery/Zephyr/6.jpg'
import test7 from '../../assets/Pics/RaghuGallery/Zephyr/7.jpg'
import test8 from '../../assets/Pics/RaghuGallery/Zephyr/8.jpg'
import test9 from '../../assets/Pics/RaghuGallery/Zephyr/9.jpg'
import test10 from '../../assets/Pics/RaghuGallery/Zephyr/10.jpg'
import test11 from '../../assets/Pics/RaghuGallery/Zephyr/11.jpg'
import test12 from '../../assets/Pics/RaghuGallery/Zephyr/12.jpg'
                ...
                <body id="clubBody">
                    <div className={`${style.container} ${style.grad1} grad1 mx-auto flex px-5 py-24 md:flex-row flex-col items-center mt-20`} >
                        <h1 className={`${style.pge1} flex title-font mb-4 font-medium text-white`} >
                            <b id="estrella">
                                <span className={`${style.clubName} `}>Zephyr</span>
                            </b>
                        </h1>
                    </div>
                        ...
                        <div className={`${style.container} ${style.coursescontainer}`}>
                            ...
                            <article className={style.course} id="coordi1">
                                <div className={style.courseimage}>
                                    <a href="../Pics/shreya.jpg" target="_blank"><img src={jatin} /></a>
                                </div>
                            ...
                            <article className={style.course}>
                                <div className={style.courseimage}>
                                    <a href="../Pics/priyanshu.png" target="_blank"><img src={pallavi} /></a>
                                </div>
                                {/* style="margin-top: 3vmin; margin-bottom: 3vmin;" */}
                                <h3 >Pallavi Chouhan</h3>
