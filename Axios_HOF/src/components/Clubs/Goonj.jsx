...
import { ramanuj, ashutosh } from "../../assets/index"

import test1 from '../../assets/Pics/RaghuGallery/Goonj/1.jpg'
import test2 from '../../assets/Pics/RaghuGallery/Goonj/2.jpg'
import test3 from '../../assets/Pics/RaghuGallery/Goonj/3.jpg'
import test4 from '../../assets/Pics/RaghuGallery/Goonj/4.jpg'
import test5 from '../../assets/Pics/RaghuGallery/Goonj/5.jpg'
import test6 from '../../assets/Pics/RaghuGallery/Goonj/6.jpg'
import test7 from '../../assets/Pics/RaghuGallery/Goonj/7.jpg'
import test8 from '../../assets/Pics/RaghuGallery/Goonj/8.jpg'
import test9 from '../../assets/Pics/RaghuGallery/Goonj/9.jpg'
import test10 from '../../assets/Pics/RaghuGallery/Goonj/10.jpg'
import test11 from '../../assets/Pics/RaghuGallery/Goonj/11.jpg'
import test12 from '../../assets/Pics/RaghuGallery/Goonj/12.jpg'
                ...
                <body id="clubBody">
                    <div className={`${style.container} ${style.grad1} grad1 mx-auto flex px-5 py-24 md:flex-row flex-col items-center mt-20`} >
                        <h1 className={`${style.pge1} flex title-font mb-4 font-medium text-white`} >
                            <b id="estrella">
                                <span className={`${style.clubName} `}>Goonj</span>
                            </b>
                        </h1>
                    </div>
                        ...
                        <div className={`${style.container} ${style.coursescontainer}`}>
                            ...
                            <article className={style.course} id="coordi1">
                                <div className={style.courseimage}>
                                    <a href="../Pics/shreya.jpg" target="_blank"><img src={ramanuj} /></a>
                                </div>
                                {/* style="margin-top: 3vmin; margin-bottom: 3vmin;" */}
                                <h3 >Ramanuj Dodiya</h3>
                            ...
                            <article className={style.course}>
                                <div className={style.courseimage}>
                                    <a href="../Pics/priyanshu.png" target="_blank"><img src={ashutosh} /></a>
                                </div>
                                {/* style="margin-top: 3vmin; margin-bottom: 3vmin;" */}
                                <h3 >Ashutosh Rajput</h3>
